...
All tests use mocked responses to avoid external dependencies.
"""
...
class TestAtlanExtractorFunctions(unittest.TestCase):
    ...
    def test_get_auth_token_from_env(self, mock_getenv, mock_json_load, mock_file):
        """Test authentication token retrieval from environment variable"""
        mock_getenv.return_value = "env_token_123"
        mock_json_load.return_value = {"auth_token": "config_token"}
        
        import main
        # Reload the module to test config loading with mocked file
        import importlib
    ...
    @patch('main.json.load')
    @patch('main.os.getenv')
    def test_get_auth_token_from_config(self, mock_getenv, mock_json_load, mock_file):
        """Test authentication token retrieval from config file"""
        mock_getenv.return_value = None
        mock_json_load.return_value = {"auth_token": "config_token_456"}
    ...
    @patch('main.os.getenv')
    @patch('main.sys.exit')
    def test_get_auth_token_missing(self, mock_exit, mock_getenv, mock_json_load, mock_file):
    ...
    @patch('main.get_auth_token')
    def test_make_api_request_success(self, mock_auth, mock_post):
    ...
    @patch('main.requests.post')
    @patch('main.get_auth_token')
    def test_make_api_request_http_error(self, mock_auth, mock_post):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('main.json.load')
    def test_get_connections_success(self, mock_json_load, mock_file, mock_request):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('main.json.load')
    def test_get_connections_empty_response(self, mock_json_load, mock_file, mock_request):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('main.json.load')
    def test_get_databases_success_with_string_replacement(self, mock_json_load, mock_file, mock_request):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('main.json.load')
    def test_get_databases_json_error(self, mock_json_load, mock_file, mock_request):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('main.json.load')
    def test_get_databases_api_failure(self, mock_json_load, mock_file, mock_request):
